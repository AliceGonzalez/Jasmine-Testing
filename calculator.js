...
function setupIntialValues() {
  ...
  amountUI.value = inputValues.amount;
  yearsUI.value = inputValues.years;
  rateUI.value = inputValues.rate;
...
function update() {
  let curretUIValues = getCurrentUIValues();
  let monthlyPayment = calculateMonthlyPayment(curretUIValues);
